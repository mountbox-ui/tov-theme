                    ...
                    <li class="job-item flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-6" 
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-[12px]">
                                <?php if ($category) : ?>
                                    <span class="flex-none rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"><?php echo esc_html($category); ?></span>
                                <?php endif; ?>
                                
                                <?php if ($job_type) : ?>
                                    <span class="flex-none rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"><?php echo ucfirst(str_replace('-', ' ', $job_type)); ?></span>
                                <?php endif; ?>
                                
                                <?php if ($location) : ?>
                                    <span class="flex-none rounded-full bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"><?php echo esc_html($location); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
