...
<div class="bg-white py-24 sm:py-32 dark:bg-gray-900">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="flex flex-col gap-10 py-12 first:pt-0 last:pb-0 sm:flex-row">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=8&w=1024&h=1024&q=80" alt="" class="aspect-[4/5] w-[350px]  flex-none rounded-2xl object-cover outline outline-1 -outline-offset-1 outline-black/5" />
            ...
            <div class="max-w-xl flex-auto">
                ...
                <p class="my-6 text-base/7 italic text-gray-600">"At our care home, we provide compassionate, safe, personalized support so every resident feels valued, respected, and genuinely cared for."</p>
