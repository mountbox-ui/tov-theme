            ...
            <div class="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <?php while ($past_events->have_posts()) : $past_events->the_post();
                    ...
                    <a href="<?php echo get_permalink(get_the_ID()); ?>" class="block group">
                        <article class="group flex flex-col sm:flex-row gap-6 rounded-lg overflow-hidden p-3 hover:shadow-sm transition-shadow duration-300 hover:bg-white cursor-pointer  md:h-[200px]">
