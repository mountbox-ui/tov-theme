...
function hero_section_buttons_shortcode($atts) {
 ...
 $arrow_icon = '<span class="ml-2 inline-block transform transition-transform duration-300 ease-in-out group-hover:translate-x-2">
    ...
    $phone_icon = '<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" fill="none">
  <path d="M22.0696 16.0529L17.1001 13.9231C16.8878 13.8327 16.6518 13.8136 16.4278 13.8688C16.2037 13.924 16.0036 14.0506 15.8577 14.2293L13.6569 16.9182C10.2029 15.2897 7.42332 12.5101 5.79482 9.05612L8.48369 6.85533C8.66281 6.70965 8.78958 6.50958 8.84483 6.28541C8.90007 6.06123 8.88077 5.82517 8.78985 5.61295L6.66006 0.643418C6.56027 0.414646 6.38379 0.227861 6.16104 0.115272C5.93829 0.00268228 5.68324 -0.0286549 5.43986 0.0266638L0.825297 1.09156C0.59065 1.14575 0.381298 1.27787 0.231409 1.46636C0.0815203 1.65484 -5.40529e-05 1.88857 2.68719e-08 2.1294C2.68719e-08 13.5105 9.22469 22.7174 20.588 22.7174C20.8289 22.7176 21.0628 22.6361 21.2514 22.4862C21.4399 22.3363 21.5721 22.1269 21.6263 21.8921L22.6912 17.2776C22.7462 17.033 22.7142 16.7769 22.6007 16.5534C22.4873 16.3299 22.2994 16.1529 22.0696 16.0529Z" fill="white"/>
    ...
    $phone = '<a href="' . esc_url($atts['phone_url']) . '" class="btn-1 inline-flex w-[152px] items-center justify-center gap-1.5 sm:gap-2 rounded-md border border-white/30 text-white  sm:px-6 sm:py-4 bg-[rgba(28, 35, 33, 0.20)] opacity-[0.7983] text-base sm:text-lg hover:bg-white/10 transition-colors whitespace-nowrap sm:w-auto">'
