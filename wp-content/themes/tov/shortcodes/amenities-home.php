        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 relative z-10">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0 items-start">
                ...
                <div class="text-white lg:sticky top-12">
                    ...
                    <a href="<?php echo home_url('/contact-us'); ?>" class="btn btn-primary bt-1 bg-white text-[#2C5F6F] hover:bg-white hover:text-[#2C5F6F] hover:svg:hover">
                        Get In Touch
                    ...
                    <a href="<?php echo home_url('/contact-us/?form=brochure'); ?>" class="bt-transparent flex">
                        Download Brochure
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-12 pt-[50px] md:pt-[50px] lg:pt-0">
