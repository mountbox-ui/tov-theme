        ...
        <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[48px]">
                ...
                <div class="lg:border-r lg:border-gray-200 lg:pr-8">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Biannual, 'In-Home', Dental Hygienist Appointments</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Weekly cut & blow dry</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Weekly standard manicure</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Pedicure once-a-month</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Complimentary use of the café area by residents & guests</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Chiropody every 8 weeks</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M2.18817 0H4.49085L3.25564 4.60745H0.0429195L2.18817 0ZM6.87535 16H7.37229V5.85878H0L6.87535 16ZM8.62382 16H9.12077L15.9941 5.85459L8.62394 5.85255L8.62382 16ZM5.78124 0H10.1167L11.3519 4.60745H4.54393L5.78124 0ZM11.4091 0H13.8182L15.9593 4.60745H12.6464L11.4091 0Z" fill="#12A3BB"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Communal newspapers</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="lg:border-r lg:border-gray-200 lg:pr-8">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">All meals & snacks</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Drinks inclusive of alcohol</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Weekly programme of activities</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Your care</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Wi-Fi for residents & guests</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Sky TV in the cinema room</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="w-4 h-4 mt-1 flex-shrink-0">
                                <path d="M8.33333 16.6667C12.9358 16.6667 16.6667 12.9358 16.6667 8.33333C16.6667 3.73083 12.9358 0 8.33333 0C3.73083 0 0 3.73083 0 8.33333C0 12.9358 3.73083 16.6667 8.33333 16.6667ZM12.8808 6.21417L7.5 11.595L3.99417 8.08917L5.1725 6.91083L7.5 9.23833L11.7025 5.03583L12.8808 6.21417Z" fill="#CDAC79"/>
                            </svg>
                            <span class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">All housekeeping, laundry & maintenance</span>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="mb-8">
                        <p class="text-[#757575] font-lato text-[18px] font-normal leading-[26px] mb-2">Residential care from £1,550</p>
                        <p class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">Dementia care from £1,790</p>
                    </div>

                    <h4 class="text-[#09090B] font-lato text-[20px] font-bold leading-[26px] mb-4">Short Respite Stay</h4>
                    <p class="text-[#757575] font-lato text-[18px] font-normal leading-[26px]">
